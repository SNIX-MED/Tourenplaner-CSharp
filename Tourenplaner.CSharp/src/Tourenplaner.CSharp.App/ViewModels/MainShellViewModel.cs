...
public sealed partial class MainShellViewModel : ObservableObject
{
        ...
        StorageRepositoryBundle repositories)
    {
        ...
        _tourRepository = repositories.TourRecordStore;
        ...
        start.RefreshAsync().Forget();
        InitializeUserSelectionAsync().Forget();
    }
    ...
    public string SelectedUserName
    {
        ...
        set
        {
            ...
            SwitchCurrentUserAsync(normalized).Forget();
        }
    }
    ...
    private void TriggerSectionRefreshOnce(object? section)
    {
        ...
        TryRefreshSectionAsync(section).Forget();
    }
    ...
    private void OnToastNotificationRequested(object? sender, ToastNotification notification)
    {
        if (System.Windows.Application.Current?.Dispatcher?.CheckAccess() == false)
        {
        ...
        ShowToastAsync(notification).Forget();
    }
